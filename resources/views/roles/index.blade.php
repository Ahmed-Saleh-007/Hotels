...
<div class="card">
    ...
    <div class="card-body">
        ...
        {!! Form::open(['id' => 'delete_all','url' => route('roles.destroyAll'), 'method' => 'delete']) !!}
        {!! $dataTable->table(['class' => 'dataTable table table-striped table-hover table-bordered'], true) !!}
        {!! Form::close() !!}
    </div>
</div>

<!-- Modal delete multi no ajax -->
            ...
            <div class="modal-body">
                <div class="alert alert-danger">
                    ...
                    <div class="not_empty_record hidden">
                        <h4>{{ trans('admin.ask_delete_itme') }} <span class="record_count"></span> {{ trans('admin.question_mark') }} </h4>
                    </div>
                </div>
            </div>

      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="ajax_create_content">
            ...
            <div class="form-group">
                ...
                {!! Form::select('floor_id', (auth()->user()->level != 'admin') ? App\Models\Floor::where('manager_id', auth()->user()->id)->pluck('name', 'id') : App\Models\Floor::pluck('name', 'id') , old('floor_id'), ['class' => 'form-control', 'placeholder' => '...']) !!}
            </div>
